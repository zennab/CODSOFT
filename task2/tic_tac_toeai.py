...
class TIC_TAC_TOE_AI:
    def __init__(self, root):
       #initial design
        self.window = root
        self.make_canvas = Canvas(self.window, background="black", relief=GROOVE, bd=3)
    ...
    def decorating(self):# Basic Set-up
        Label(self.make_canvas, text="AI TO TIC TAC TOE", bg="blue", fg="green", font=("Helvetica", 20, "bold")).place(x=110, y=10)
        ...
        self.machine_first_control = Button(self.make_canvas, text="AI battles You", font=("Arial", 15, "bold", "normal"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=lambda: self.control_give("machine_first"))
        self.machine_first_control.place(x=15, y=380)

        self.human_first_control = Button(self.make_canvas, text="You battle AI", font=("Helvetica", 15, "bold", "normal"), bg="#262626", activebackground="#262626", fg="#9d9dff", relief=RAISED, bd=3, command=self.control_give)
        self.human_first_control.place(x=240, y=380)

        self.reset_btn = Button(self.make_canvas, text="Reset", font=("Helvetica", 15, "bold", "normal"), bg="#262626", activebackground="#262626", disabledforeground="grey", fg="#9d9dff", relief=RAISED, bd=3, command=self.reset, state=DISABLED)
